...
> (`AUDIO_ENABLED=false`). Solo se habilita con autorización y consentimiento.
...
Para aplicar esta recomendación, ajustaremos la lógica del orquestador en tu archivo `backend/src/core/gestor_diagnostico.py`.

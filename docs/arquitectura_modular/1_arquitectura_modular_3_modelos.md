...
- **Ubicación en Código**: `backend/src/interfaces/api/v1/endpoints/webhook.py`, `backend/src/interfaces/api/v1/router.py`, `main.py`
...
- **Ubicación en Código**: `backend/src/core/services/webhook_service.py`, `backend/src/core/gestor_diagnostico.py`, `backend/src/core/gemini_queue.py`, `backend/src/core/audio_processor.py`
...
- **Ubicación en Código**: `backend/src/infrastructure/modelo_ml.py`, `backend/src/infrastructure/motor_rag.py`
...
- **Tecnología**: FAISS Index / TF-IDF Vectorizer sobre `machine_learning/manuals/manual_procedimientos.txt`.
...
- **Ubicación en Código**: `backend/src/infrastructure/database/repositories/`, `backend/src/infrastructure/database/machine_learning/models/`, `backend/alembic/`.

...
from src.core.security import cifrar_texto_reversible, descifrar_texto_reversible, hash_identificador_persistencia
...
def test_alembic_head_es_20260807_06():
    """Verifica que la migración 20260807_05 sea el head activo de Alembic."""

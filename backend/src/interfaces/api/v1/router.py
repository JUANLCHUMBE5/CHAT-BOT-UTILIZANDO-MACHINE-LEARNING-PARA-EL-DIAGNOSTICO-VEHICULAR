...
from src.interfaces.api.v1.endpoints.posttest import router as posttest_router
...
api_router.include_router(posttest_router, prefix="/posttest", tags=["Post-test de tesis"])

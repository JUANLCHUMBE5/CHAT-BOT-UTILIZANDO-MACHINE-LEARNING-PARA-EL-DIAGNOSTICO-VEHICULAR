...
CLAVES_PERMITIDAS = {
    "DATABASE_URL", "GEMINI_API_KEY", "META_ACCESS_TOKEN", "META_PHONE_NUMBER_ID",
    "TOKEN_WHATSAPP", "TELEFONO_ID",
    "META_APP_SECRET", "META_VERIFY_TOKEN", "TWILIO_ACCOUNT_SID",
    "TWILIO_AUTH_TOKEN", "TWILIO_WHATSAPP_FROM", "JWT_SECRET_KEY",
    "PRIVACY_SECRET_KEY", "LOCAL_AUTH_USERNAME", "LOCAL_AUTH_PASSWORD",
